...
// Shared by the login and signup pages. Kicks off Supabase's OAuth redirect
// flow; the browser client stashes the PKCE verifier in a cookie so the
// `/auth/callback` route can exchange the returned `code` for a session.
export function GoogleSignInButton() {
  ...
  async function handleClick() {
    ...
    // On success the browser navigates to Google, so there's no state to reset.
  }
